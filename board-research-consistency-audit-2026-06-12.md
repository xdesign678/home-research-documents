...
| 红棉花 | 可认真观察 | 补充研究、短版、导航、缺口登记、官方入口补查 | 一致 | R9 已补到味道大负向样本，仍缺具体系列、CMA/TVOC、长期入住、真实交付 |
| 水性科天 | 可认真观察但更谨慎 | 补充研究、短版、导航、候选矩阵、缺口登记 | 一致 | R10 已补到 ENF/F4/至原相关味道和试纸争议；还缺系列拆分、无醛口径、检测报告、安装后气味闭环 |
| 露水河 | 可认真观察 | 补充研究、短版、导航、候选矩阵、官方入口补查 | 一致 | R10 有“露水河 + 靓时”组合低味样本，但不能归因到单一品牌；还缺到货标签、系列、渠道和独立低味样本 |
| 克诺斯邦/可丽芙 | 可认真观察 | 补充研究、短版、导航、柜门饰面链风险、缺口登记 | 一致 | 授权、批次、真假、贴面和整屋 CMA |
| 博耐克/BERNECK | 高端柜门观察候选 | 补充研究、短版、官方验真、柜门饰面链风险、候选矩阵、缺口登记 | 一致 | 可核验北新木业授权链、进口链、素板/精板、贴面、异形件；R9 已提示纸质授权可造假 |
| 靓时靓面 | 花色/柜门候选 | 补充研究、短版、柜门饰面链风险、候选矩阵、导航 | 一致 | R10 仍主要是组合低味、花色、价格和多品牌理解；SPB 净味板、白月灰、C22/U705 平替还缺检测、授权、到货标签和长期落地气味 |
...
| 丽特曼 | 门板/饰面链条低证据对象 | 补充研究、低证据身份核查、候选矩阵、缺口登记 | 一致 | R8 已初筛，后续只确认基材、膜、饰面、门板体系和授权关系 |
| 爱德板 | 低证据候选 | 补充研究、低证据身份核查、候选矩阵、缺口登记 | 一致 | R8 搜索误命中多，仍需确认完整名称、厂家、检测、部位和真实评论 |
| 伟业欧松板 | 低证据欧松/渠道候选 | 补充研究、低证据身份核查、候选矩阵、缺口登记 | 一致 | R8 已初筛，仍需拆清素板、精板、PET、贴面和渠道交付 |
...
5. 红棉花、靓时靓面、水性科天等对象还需要更多安装后气味、检测和长期入住反馈；R9 红棉花负向样本和 R10 水性科天味道/试纸争议都提示不能上调过快。
6. 露水河和靓时 R10 只补到组合低味样本和讨论线索，不能把“没味道”直接归因到某一个板材品牌。

## 本轮审查后的处理

本轮不改排名，也不升级候选；已把 R10 新增小红书证据同步进总览口径。当前资料体系的口径是稳定的：前三优先、观察层继续补证、渠道品牌按门店审、柜门链条拆基材和加工、遇小红书安全限制即停。手动补证入口也应按同一优先级执行：先补最可能影响实际决策的博耐克、合生雅居和红棉花，再补靓时靓面、水性科天、露水河及低证据候选。
