...
- 小红书安全限制 300017 已记录；后续已完成 R7、R8、R9、R10 低频只读复查，后续复查队列已写入补充研究文档和逐对象补查卡。

## 当前未完成但已经排队的部分

- 小红书自动浏览曾因安全限制暂停；目前已按 R7-R10 低频只读恢复过，但后续仍必须少量、公开、只读，遇登录、验证码、滑块、账号安全、访问异常或 300017 立即停。
