...
| `xiaohongshu-board-extension-research-2026-06-12.md` 要更详细 | 已完成 | 该文件已扩展为 1556 行，含帖子与评论细节回填和 D 区复盘总账 | 已从高度概括改为分帖记录、评论分层、证据权重、不能外推边界和下一轮队列 |

## 当前能否继续自动查小红书

| 判断项 | 当前结论 | 处理方式 |
|---|---|---|
| 是否满足恢复自动复查条件 | 暂不满足 | 曾出现“安全限制 / 访问链接异常 / 300017”，按 `AGENTS.md` 和安全恢复清单，不继续自动打开详情页 |
...
| 缺口 | 为什么还缺 | 下一步怎么补 |
|---|---|---|
| 小红书详情页继续深挖 | 已出现安全限制 300017，按规则不能继续自动打开 | 先按 `xiaohongshu-board-safe-resume-checklist-2026-06-12.md` 判断是否能恢复；不满足时由用户手动打开页面后按 `xiaohongshu-board-manual-evidence-intake-2026-06-12.md` 提供可见内容 |
